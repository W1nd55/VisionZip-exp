# # modify llava/model/llava_arch.py
...
#             masked = text_embeds * text_mask.unsqueeze(-1)  # [B,T,d]
...
#                 vt = vt[0]
#             if hasattr(vt, "_text2key"):
#                 vt._text_query = query_vec.detach().to(vt.device)
#         except Exception as e:
#             # print("[SparseZip TextAware] failed to set _text_query:", repr(e))
#             pass
