...
class LlavaSparseZipModel(LlavaModel):
    def __init__(
        ...
        alphas = ScoringAlphas(
            ...
            mutual=alpha_config[2],
        )
        dynk = DynamicKConfig(
            c=dynk_c, k_min=k_min, k_max=k_max,
        )
        ...
        print("[SparseZip] VisionZipCompressor with Dynamic-K + "
              f"hierarchical merge attached. ctx={ctx_num}, "
              f"k_range=[{k_min},{k_max}], alphas={alpha_config}")