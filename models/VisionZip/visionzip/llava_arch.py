...
def prepare_inputs_labels_for_multimodal_visionzip(
    ...
    for batch_idx, cur_input_ids in enumerate(input_ids):
        ...
        if num_images == 0:
            ...
            cur_input_embeds_1 = self.get_model().embed_tokens(cur_input_ids.to(self.device))
        ...
        cur_input_ids_noim_device = [x.to(self.device) for x in cur_input_ids_noim]
        cur_input_embeds = self.get_model().embed_tokens(torch.cat(cur_input_ids_noim_device))
